...
public class OpenApiController {
	   ...
	   @RequestMapping(value="/CompanySelect.do")
		public String CompanySelect(CompanyVO vo, Model model) throws Exception{
				
				model.addAttribute("li", service.list(vo));
			
			return "/openapi/company_select.jsp";
		}
	   
	   @RequestMapping(value="/CompanySelectMap.do")
		public String CompanySelectMap(CompanyVO vo, Model model) throws Exception{
				
				model.addAttribute("li", service.list(vo));
			
			return "/openapi/company_selectMap.jsp";
		}
	   
	   @RequestMapping(value="/CompanySelectOne.do")
		public String CompanySelectOne(CompanyVO vo, Model model) throws Exception{
				
		   model.addAttribute("m", service.selectCompany(vo));
		  
			return "/openapi/company_selectOne.jsp";
		}
	   
	     
	   @RequestMapping(value="/EvSelect.do")
		public String EvSelect(EvSearchVO vo, Model model) throws Exception{
				
				model.addAttribute("li", service.listEv(vo));
			
			return "/openapi/evsearch_select.jsp";
		}
	   
	   @RequestMapping(value="/EvSelectOne.do")
		public String EvSelectOne(EvSearchVO vo, Model model) throws Exception{
				
				model.addAttribute("m", service.selectEvSearch(vo));
			
			return "/openapi/evsearch_selectOne.jsp";
		}
	   
	   
	   @RequestMapping(value="/EvSelectMap.do")
		public String EvSelectMap(EvSearchVO vo, Model model) throws Exception{
				
				model.addAttribute("li", service.listEv(vo));
			
			return "/openapi/evsearch_selectMap.jsp";
		}
